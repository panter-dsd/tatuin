...
you must use the [obsidian-local-rest-api](https://github.com/coddingtonbear/obsidian-local-rest-api) plugin (look for "Local REST API" inside Obsidian's community plugins).
